  ...
  <div class="bg-image w-full min-h-screen flex flex-wrap justify-center items-center gap-3 py-5">
    <div class="backdrop w-10/12 md:w-1/4 bg-white bg-opacity-10 rounded p-3 text-white border border-gray-300 shadow-lg">
      ...
      <div class="w-full mb-3 pb-3 border-b border-1 border-white">
        <h3 class="text-xl font-semibold text-shadow">Ingeniería en sistemas y tecnologías de la información</h3>
      </div>
      <!-- body -->
      <div>
        <img src="https://ipn-ingenieria-licenciatura.com/wp-content/uploads/2020/04/ingenier%C3%ADa-en-sistemas-computacionales-1.jpg" alt="image2" class="w-full h-48 object-cover mb-2">
        <p class="mb-3 tracking-wide text-base text-shadow">
          Ingrese para poder visualizar los proyectos de la carrera.
        </p>
        <a href="{{ route('carrera.index') }}" :active="request()->routeIs('carrera.index" class="backdrop bg-white bg-opacity-0 border border-white px-3 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 hover:bg-opacity-10 text-lg">Detalles</a>
      </div>
    </div>
    ...
    <div class="backdrop w-10/12 md:w-1/4 bg-white bg-opacity-10 rounded p-3 text-white border border-gray-300 shadow-lg"> 
            <!-- header -->
      <div class="w-full mb-3 pb-3 border-b border-1 border-white">
        <h3 class="text-xl font-semibold text-shadow">Ingeniería en autotrónica y automatización</h3>
      </div>
      <!-- body -->
      <div>
        <img src="https://1.bp.blogspot.com/-2j1oOIdtTr4/W42Q5FfBqyI/AAAAAAAAHGs/2YdB8TKAfL0wmTZkjSBLYzB1N3Al5UmMQCLcBGAs/s1600/automatizacion-industrial-0.jpg" alt="image2" class="w-full h-48 object-cover mb-2">
        <p class="mb-3 tracking-wide text-base text-shadow">
          Ingrese para poder visualizar los proyectos de la carrera.
        </p>
        <a href="{{ route('carrera.create') }}" :active="request()->routeIs('carrera.create" class="backdrop bg-white bg-opacity-0 border border-white px-3 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 hover:bg-opacity-10 text-lg">Detalles</a>
      </div>
    </div>
    ...
    <div class="backdrop w-10/12 md:w-1/4 bg-white bg-opacity-10 rounded p-3 text-white border border-gray-300 shadow-lg"> 
            <!-- header -->
      <div class="w-full mb-3 pb-3 border-b border-1 border-white">
        <h3 class="text-xl font-semibold text-shadow">Ingeniería en procesos y gestión industrial</h3>
      </div>
      <!-- body -->
      <div>
        <img src="https://retos-operaciones-logistica.eae.es/wp-content/uploads/2018/05/iStock-952980884-600x400.jpg" alt="image2" class="w-full h-48 object-cover mb-2">
        <p class="mb-3 tracking-wide text-base text-shadow">
          Ingrese para poder visualizar los proyectos de la carrera.
        </p>
        <a href="{{ route('ver.index') }}" :active="request()->routeIs('ver.index')" class="backdrop bg-white bg-opacity-0 border border-white px-3 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 hover:bg-opacity-10 text-lg">Detalles</a>
      </div>
    </div>
