  ...
  <div class="bg-image w-full min-h-screen flex flex-wrap justify-center items-center gap-3 py-5">
    <div class="backdrop w-10/12 md:w-1/4 bg-white bg-opacity-10 rounded p-3 text-white border border-gray-300 shadow-lg">
      ...
      <div class="w-full mb-3 pb-3 border-b border-1 border-white">
        <h3 class="text-xl font-semibold text-shadow">Por semestre</h3>
      </div>
      <!-- body -->
      <div>
        <img src="http://eltoper.com/wp-content/uploads/2017/08/BUAPSANJOS%C3%891.jpg" alt="image1" class="w-full h-48 object-cover mb-2">
        <p class="mb-3 tracking-wide text-base text-shadow">
          Ingrese para poder visualizar los proyectos por semestre.
        </p>
        
        <a href="{{ route('teacher.courses.create') }}" :active="request()->routeIs('teacher.courses.create')" button type="button" class="backdrop bg-white bg-opacity-0 border border-white px-3 py-1.5 rounded focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 hover:bg-opacity-10 text-lg">Detalles</a>
