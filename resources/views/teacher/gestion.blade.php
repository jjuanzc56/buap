        ...
        <div class="md:flex items-center -mx-10">
            ...
            <div class="w-full md:w-1/2 px-10 ">
                <div class="mb-10">
                    ...
                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="codigo_proyecto" type="text" placeholder="--codigo--" name="codigo_proyecto">        
                        <a href="{{ route('teacher.courses.create') }}" :active="request()->routeIs('teacher.courses.create')" button type="button" class="bg-gradient-to-br from-blue-800 to-green-900 opacity-100 hover:opacity-100 text-white hover:text-gray-900 rounded-full px-10 py-2 font-semibold">Unirse al proyecto</a>     
                    </div>
                </div>
            </div>
        </div>
