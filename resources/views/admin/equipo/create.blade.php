<x-app-layout>
    ...
    <form method="post" action="{{url('/admin/equipo')}}" enctype="multipart/form-data">
    @csrf
...
<div class="-mx-3 md:flex mb-6">
    ...
    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="nombre_equipo" type="text" placeholder="Nombre del equipo" name="nombre_equipo">
