<x-app-layout>
    ...
    <form method="post" action="{{url('/admin/empresa/'.$empresa->id)}}" enctype="multipart/form-data">
    @csrf
    {{ method_field('PATCH') }}
...
<div class="-mx-3 md:flex mb-6">
    ...
    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="nombre_empresa" type="text" placeholder="Nombre de la empresa" name="nombre_empresa" value="{{$empresa->nombre_empresa}}">

    <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="archivo_empresa">
    Archivo de empresa
    </label>
    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="archivo_empresa" type="text" placeholder="Link del archivo de empresa" name="archivo_empresa" value="{{$empresa->archivo_empresa}}">

    <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="representante">
    Representante de la empresa
    </label>
    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="representante" type="text" placeholder="Representante de la empresa" name="representante" value="{{$empresa->representante}}">
    ...
    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="created_at" type="date" name="created_at" value="{{$empresa->created_at}}">
    </div>
